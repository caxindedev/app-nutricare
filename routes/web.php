...
Route::get('/corfirmarsub/{token?}',function ($token) {
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/aluno/medidas/evolucao', [MedidaController::class, 'evolucao'])->name('medida.evolucao');

    Route::get('/aluno/historico', [AlunoController::class, 'historico'])->name('aluno.historico');
    ...
    Route::get('/secretaria/agenda/grupo', [AgendaController::class, 'agendaGrupo'])->name('secretaria.agendaGrupo');
