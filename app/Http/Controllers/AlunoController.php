...
class AlunoController extends Controller
{
    ...
    public function instrucoes(){
        ...
        return view('aluno.medidas.instrucoes');
    ...
    public function dadosPessoais(){
        $user = Auth::user();
        return view('aluno.dadosPessoais', compact('user'));
    }
    ...
    public function store(Request  $request){
        $aluno = $request->only(['nome', 'genero', 'email', 'data_nascimento', 'telefone', 'whatsapp', 'empresa_id']); // apenas campos permitidos para os alunos
        $user = User::create([
            'name' => $aluno['nome'],
            'email' => $aluno['email'],
        ...
        $aluno = Aluno::create($request->only([ 'user_id','genero', 'data_nascimento', 'telefone', 'whatsapp', 'empresa_id']));
        ...
        Mail::to($request->user()->email)->queue(new NovoAlunoEmail($user));
