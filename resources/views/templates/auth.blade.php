...
<head>
    ...
    <style>
        .fc-event {
            font-size: 16px;
            /* Altere este valor para o tamanho de fonte desejado */
...
<body>
    ...
    <script>
        var dados = @json(@$agenda);
    </script>
    <script src="{{ url('assets/js/agendamento.js') }}"></script>
    ...
    <script>
        ...
        var pusher = new Pusher('13c235f8e9c9bd75d3c1', {
            cluster: 'eu'
        });

        var channel = pusher.subscribe('logado-evento');
