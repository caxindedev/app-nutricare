...
<html lang="en" data-layout="vertical" data-layout-style="detached" data-sidebar="light" data-topbar="dark"
    ...
    <!-- Mirrored from themesbrand.com/velzon/html/interactive/auth-signin-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Aug 2023 20:28:00 GMT -->
    <head>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center mt-sm-5 mb-2 text-white-50">
                                ...
                                <p class="mt-3 fs-15 fw-medium">xxx xxxx xxxxx</p>
                            </div>
                        </div>
                    </div>
                    <!-- end row -->
