                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="#" class="d-inline-block auth-logo">
                                    <img src="{{ url('assets/images/nutricare-logo.png') }}" alt="" height="100">
                                </a>
                            </div>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    <h5 class="text-primary">Nutricare</h5>
                                    <p class="text-muted">seja bem vindo, faça o login.</p>
                                </div>
                                <div class="p-2 mt-4">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                ...
                                </script> NutriCare<i class="mdi mdi-heart text-danger"></i>
                                by Dra Scheila Pagés
                            </p>
                        </div>
                    </div>
                </div>
