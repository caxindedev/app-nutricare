                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="#" class="d-inline-block auth-logo">
                                    <img src="{{ url('assets/images/nutricare-logo.png') }}" alt="" height="20">
                                </a>
                            </div>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Poderas ter outra senha</p>
                                ...
                                <div class="alert border-0 alert-warning text-center mb-2 mx-2" role="alert">
                                    Insira o seu email, será enviada as intruções
                                </div>
                                <div class="p-2">
                                    <form method="POST" action="{{ route('password.email') }}">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input class="form-control pe-5 password-input" id="email" type="email" name="email" :value="old('email')" required autofocus>
                                        </div>

                                        <div class="text-center mt-4">
                                            <button class="btn btn-info w-100" type="submit">Enviar link no meu email</button>
                                        </div>
                                    </form><!-- end form -->
                                </div>
                            </div>
