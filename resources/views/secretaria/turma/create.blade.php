                                    ...
                                    <div class="live-preview">
                                        <form method="POST" action="{{ route('turma.store') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="ForminputState" class="form-label">Empresa</label>
                                                        <select id="ForminputState" name="curso_id" class="form-select" data-choices data-choices-sorting="true">
