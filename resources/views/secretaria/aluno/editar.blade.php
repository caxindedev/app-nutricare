                ...
                <div class="col-xxl-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Editar Paciente</h4>
                            ...
                            <div class="live-preview">
                                ...
                                <form method="POST" action="{{ route('aluno.update', $aluno->id) }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="compnayNameinput" class="form-label">Altura</label>
                                                <input type="text" name="altura" value="{{ $aluno->altura }}" required class="form-control"
                                                    id="compnayNameinput">
                                            </div>
                                        </div>
                                        <!--end col-->
